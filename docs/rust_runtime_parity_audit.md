...
- Full Python suite:
  ...
  - Result: `1009 passed, 614 warnings`
...
| --- | --- | --- |
| Same suite can run against Python backend | `.\.venv\Scripts\python.exe -m pytest --no-cov -q` passes with `1009 passed, 614 warnings` | Done for Python |
