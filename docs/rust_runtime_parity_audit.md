...
- Full Python suite:
  ...
  - Result: `899 passed, 465 warnings`
...
- Direct `ReticulumTelemetryHubAPI` topic CRUD, topic description clearing,
  ...
  identity announce merge behavior
...
- Direct `ReticulumTelemetryHubAPI` tests beyond current topic/subscriber CRUD,
  ...
  attachment association, advanced identity status/deduplication, subject-rights
  storage, config, and app-info behavior
