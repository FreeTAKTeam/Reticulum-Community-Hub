...
- Full Python suite:
  ...
  - Result: `1010 passed, 624 warnings`
...
| --- | --- | --- |
| Same suite can run against Python backend | `.\.venv\Scripts\python.exe -m pytest --no-cov -q` passes with `1010 passed, 624 warnings` | Done for Python |
