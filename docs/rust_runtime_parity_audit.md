...
- Full Python suite:
  ...
  - Result: `1017 passed, 654 warnings`
...
| --- | --- | --- |
| Same suite can run against Python backend | `.\.venv\Scripts\python.exe -m pytest --no-cov -q` passes with `1017 passed, 654 warnings` | Done for Python |
