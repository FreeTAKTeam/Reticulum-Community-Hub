...
- `TelemetryDocumentation.md` (Sideband telemetry wire format)
- `example_telemetry.json` (example telemetry payloads)
...
- `InternalAPIIncrementalImplementationtasks.md` (internal planning notes)
