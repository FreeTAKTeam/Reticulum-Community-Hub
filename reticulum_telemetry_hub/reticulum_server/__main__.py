...
from reticulum_telemetry_hub.reticulum_server.delivery_defaults import DEFAULT_OUTBOUND_FANOUT_SOFT_MAX_RECIPIENTS
...
class ReticulumTelemetryHub:
    ...
    def _should_ignore_passive_command_payload(
        ...
        if not isinstance(manager, CommandManager):
            return False
        # Reason: bind through the typed manager instance so static analyzers
        # never see undefined locals when this guard short-circuits.
