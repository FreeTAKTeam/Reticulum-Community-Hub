...
from reticulum_telemetry_hub.northbound.services_config import NorthboundConfigMixin
from reticulum_telemetry_hub.northbound.services_spatial import NorthboundSpatialMixin
...
@dataclass
class NorthboundServices(NorthboundConfigMixin, NorthboundSpatialMixin):
