...
- `cargo test --workspace` passed, including the Rust HTTP/WebSocket contract,
  ...
  test suites.
- `cargo test -p r3akt-rch-server` passed, including 214 server library tests,
...
against a real TAK server profile and broader real-network Reticulum validation
