...
live LXMF receipt callback wiring, live TAK reconnect validation, inbound TAK
behavior where RCH needs it,
...
TAK server profile, and live multi-recipient LXMF fanout validation.
