    ...
    <div class="registry-shell">
      <section class="panel registry-main">
        <div class="panel-header">
          <div>
            <div class="panel-title">Mission Asset Registry Redirect</div>
            <div class="panel-subtitle">Routing to canonical mission-domain asset page...</div>
          </div>
        </div>
...
onMounted(() => {
  ...
  router
    .replace({ path: `/missions/${encodeURIComponent(missionUid)}/assets`, query: nextQuery })
    .catch(() => undefined);
});
</script>
