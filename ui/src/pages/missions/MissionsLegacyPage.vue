...
import MissionFormScreen from "./MissionFormScreen.vue";
import MissionChecklistWorkspaceScreen from "./MissionChecklistWorkspaceScreen.vue";
import MissionChecklistMissionLinkModal from "./MissionChecklistMissionLinkModal.vue";
import MissionChecklistTemplateModal from "./MissionChecklistTemplateModal.vue";
import MissionMemberAllocationModal from "./MissionMemberAllocationModal.vue";
...
const toScreenId = (value: unknown): ScreenId | null => {
...
watch(
  () => route.query.screen,
  (value) => {
    const nextScreen = toScreenId(value);
    if (!nextScreen) {
      return;
    }
