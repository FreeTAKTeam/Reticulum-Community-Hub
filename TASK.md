# TASKS
- 2026-05-01: DONE. Reduce files over 500 LoC by splitting them into smaller, cohesive modules without changing behavior.
- 2026-04-29: DONE. Upgraded the 2.9.1 transport baseline to RNS 1.2.0 while keeping LXMF 0.9.6, retained the documented mixed-version announce warning, and refreshed validation/docs for the 2.9.2 patch release.
